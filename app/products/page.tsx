...
const PRODUCTS = [
  { id: '1', name: 'Monogram Tote', brand: 'Louis Vuitton', price: 4500, image: '/products/louis-vuitton-bag.jpg', category: 'bags', tag: 'Limited Edition', rating: 4.9 },
  { id: '2', name: 'Silk Evening Dress', brand: 'Valentino', price: 3400, image: '/products/silk-dress.jpg', category: 'dresses', tag: 'New In', rating: 4.8 },
  { id: '3', name: 'Gold Jewelry Set', brand: 'Dior', price: 5200, image: '/products/gold-jewelry.jpg', category: 'jewelry', tag: 'Trending', rating: 4.9 },
  { id: '4', name: 'Statement Sunglasses', brand: 'Chanel', price: 950, image: '/products/designer-sunglasses.jpg', category: 'sunglasses', tag: 'New In', rating: 4.7 },
  { id: '5', name: 'Classic Heels', brand: 'Prada', price: 2100, image: '/products/designer-sunglasses.jpg', category: 'shoes', tag: 'Trending', rating: 4.8 },
  { id: '6', name: 'Luxury Timepiece', brand: 'Hermès', price: 8900, image: '/products/designer-watch.jpg', category: 'watches', tag: 'Almost Gone', rating: 5.0 },
  { id: '7', name: 'Silk Blouse', brand: 'Gucci', price: 1800, image: '/products/silk-dress.jpg', category: 'tops', tag: 'New In', rating: 4.6 },
  { id: '8', name: 'Embossed Shoulder Bag', brand: 'Balenciaga', price: 3200, image: '/products/louis-vuitton-bag.jpg', category: 'bags', tag: 'Trending', rating: 4.7 },
];
          ...
          {filtered.map((product, index) => (
            ...
            >
              <div className="relative w-full aspect-[3/4] overflow-hidden bg-muted mb-5">
                ...
                {/* Quick Add Button */}
                <button 
                  onClick={() => addItem({ id: product.id, productId: product.id, name: product.name, price: product.price, image: product.image, brand: product.brand })}
